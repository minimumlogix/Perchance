...
window.DEFAULT_TONES_DATA = {
  uncensored: { label: "🔓 Uncensored", description: "Unfiltered, explicit, and unrestricted narrative freedom", prompt: "The tone is completely uncensored, unfiltered, and raw. Write without restraint, puritanical boundaries, or hesitation. Content, themes, and interactions are presented with full narrative freedom.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/uncensored-tone.jpg" },
  uncensored_casual: { label: "🤬 Uncensored Casual", description: "Raw, unfiltered casual dialogue with natural profanity and mature movie banter", prompt: "The tone is uncensored, casual, and raw. Characters use natural, unfiltered conversational speech with casual profanity, mature movie-style dialogue, raw reactions, and blunt, realistic banter without holding back.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/uncensored-tone.jpg" },
  deadpan_dry: { label: "😐 Deadpan & Dry", description: "Flat delivery of absurd, chaotic, or intense situations without emotion", prompt: "The tone is deadpan and dry. Characters deliver bizarre, chaotic, or extreme statements with a completely flat voice, emotionless composure, and zero dramatic reaction.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/cynical-tone.jpg" },
  hardboiled_noir: { label: "🕵️‍♂️ Hardboiled Noir", description: "Cynical inner monologues, gritty metaphors, and tough-guy dialogue", prompt: "The tone is hardboiled pulp noir. Heavy reliance on cynical inner monologues, rain-slicked atmosphere, sharp streetwise banter, and worn-out morality.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/neo_noir-setting.jpg" },
  sarcastic_snark: { label: "😏 Sarcastic Snark", description: "Biting retorts, eye-rolling irony, and witty passive-aggressive banter", prompt: "The tone is heavy with sarcastic snark. Dialogue is loaded with biting retorts, eye-rolling irony, sharp retorts, and witty passive-aggressive banter.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/cynical-playful-tone.jpg" },
  high_octane_hype: { label: "⚡ High-Octane Hype", description: "Fast trash-talking, intense adrenaline, and electric rivalry", prompt: "The tone is high-octane hype. Blazing pacing, aggressive trash-talking, intense adrenaline, and electric rivalry where every sentence pulses with extreme energy.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/thrilling-action-tone.jpg" },
  grandiose_theatrical: { label: "🦹 Grandiose & Theatrical", description: "Dramatic eloquence, theatrical arrogance, and sweeping declarations", prompt: "The tone is grandiose and theatrical. Characters speak with dramatic eloquence, sweeping declarations, theatrical arrogance, and larger-than-life presence.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/operatic-tone.jpg" },
  tense_standoff: { label: "⏳ Tense Standoff", description: "Quiet, calculated dialogue loaded with unspoken threats", prompt: "The tone is a tense standoff. Dialogue is quiet, calculated, and loaded with unspoken threats. Every sentence feels like a trigger ready to pull.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/dark-gritty-tone.jpg" },
  bittersweet_nostalgia: { label: "🌅 Bittersweet Nostalgia", description: "Warm memories tinged with gentle longing and passing time", prompt: "The tone is bittersweet nostalgia. Focus on lingering memories, emotional warmth blended with quiet longing, and the weight of passing time.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/melancholic-tone.jpg" },
  mature_comedy: { label: "🔞 Mature Comedy", description: "Comedy tailored for adult audiences with dark or suggestive humor", prompt: "The tone is mature comedy. Humor is tailored for adult audiences, blending sharp wit, sexual innuendo, adult situations, and clever comedic timing.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/mature-comedy-tone.jpg" },
  r_rated_comedy: { label: "🎬 R-Rated Comedy", description: "High-energy comedy with crude humor, profanity, and wild situations", prompt: "The tone is an R-rated comedy. High-energy, wild, and unabashedly crude, incorporating frequent swearing, outrageous situations, physical comedy, and boundary-pushing jokes.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/r-rated-comedy-tone.jpg" },
  adult_comedy: { label: "🍷 Adult Comedy", description: "Sophisticated adult humor focusing on relationships, work, and life", prompt: "The tone is adult comedy. Focus on relatable adult humor, relationship absurdity, workplace irony, and mature banter.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/adult-comedy-tone.jpg" },
  irreverent_action_comedy: { label: "💥 Irreverent Action Comedy", description: "Wild action where nothing is sacred and humor interrupts chaos", prompt: "The tone is irreverent action comedy. Nothing is sacred—heroes, villains, authority, death, and storytelling tropes are all targets for humor amidst fast-paced action.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/irreverent-action-comedy-tone.jpg" },
  dark_action_comedy: { label: "💣 Dark Action Comedy", description: "Graphic action and violence treated with hilarious dark humor", prompt: "The tone is dark action comedy. High-octane graphic action and serious threats are treated with dark humor, witty bantering under fire, and blood-pumping comedic timing.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/dark-action-comedy-tone.jpg" },
  profane_comedy: { label: "🤬 Profane Comedy", description: "Frequent swearing and crude language as natural character speech", prompt: "The tone is profane comedy. Frequent swearing, colorful insults, and crude language are part of the character's normal speech, not just for shock value.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/profane-comedy-tone.jpg" },
  black_comedy: { label: "💀 Black Comedy", description: "Serious subjects like violence, trauma, and mortality treated with humor", prompt: "The tone is black comedy / dark comedy. Serious subjects like violence, trauma, murder, and mortality are treated with humor rather than drama.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/black-comedy-tone.jpg" },
  meta_comedy: { label: "🪞 Meta Comedy", description: "Fourth-wall breaks, genre awareness, and jokes about storytelling", prompt: "The tone is meta / self-aware comedy. Include constant fourth-wall breaks, genre awareness, self-referential jokes, and playful commentary on storytelling clichés.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/meta-comedy-tone.jpg" },
  gallows_humor: { label: "⚰️ Gallows Humor", description: "Grim, cynical, and playful humor in the face of terrible odds", prompt: "The tone is gallows humor. Characters make grim, playful, and cynical jokes in the face of hopeless odds, terrible situations, and impending danger because they don't take the world seriously.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/gallows-humor-tone.jpg" },
  chaotic_comedy: { label: "🌀 Chaotic Comedy", description: "Impulsive, unpredictable humor that interrupts serious moments", prompt: "The tone is chaotic comedy. The humor feels impulsive, unpredictable, and often interrupts serious moments with surprising twists and absurd logic.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/chaotic-comedy-tone.jpg" },
  irreverent: { label: "🤡 Irreverent", description: "Nothing is sacred: heroes, villains, death, authority, and tropes are mocked", prompt: "The tone is irreverent. Nothing is sacred—heroes, villains, death, authority, clichés, and even the story itself are all fair game for humor.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/irreverent-tone.jpg" },
  satirical: { label: "🎭 Satirical", description: "Mocks superhero tropes, pop culture, clichés, and expectations", prompt: "The tone is satirical. Intentionally mock tropes, pop culture clichés, heroic expectations, and narrative conventions with sharp satirical wit.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/satirical-tone.jpg" },
  cynical_playful: { label: "😏 Cynical but Playful", description: "Characters joke because they don't take the world seriously", prompt: "The tone is cynical but playful. Characters joke because they don't take the world seriously, keeping things witty and light even when situations are terrible.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/cynical-playful-tone.jpg" },
  violent_comedy: { label: "⚔️ Violent Comedy", description: "Graphic action exaggerated until it becomes funny rather than horrifying", prompt: "The tone is violent comedy. Graphic action and violence are exaggerated until they become funny and entertaining rather than horrifying.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/violent-comedy-tone.jpg" },
  absurdist: { label: "🤪 Absurdist", description: "Logic bends for the sake of the joke", prompt: "The tone is absurdist comedy. Reality and logic bend freely for the sake of the joke, prioritizing bizarre humor over strict plausibility.", image: "https://minimumlogix.github.io/Perchance/RP-GEN/assets/Images/cards/absurdist-tone.jpg" },
